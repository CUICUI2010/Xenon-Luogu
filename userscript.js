...
// @description	  It is like Argon Luogu, a dark, brand new theme.
// @author        Cui2010
// @homepage      https://userstyles.org/styles/218564
// @run-at        document-start
// @version       0.20211110141759
// ==/UserScript==
(function() {var css = "";
if (false || (new RegExp("^((?!blog).)*https://www.luogu.com.cn((?!blog).)*$")).test(document.location.href))
	css += [
		".am-panel-bd {",
		...
		"	}",
		"	.am-badge, .tag[data-v-5d98bc80],  span[data-v-43a42535] {",
		...
		"	    }",
		"	    .avatar-right[data-v-5137b88f], .detail[data-v-5137b88f], .combo-wrapper.text[data-v-087e057c] {",
		"	        color: #eee !important;",
		"	    }",
		...
		"	        border-color: #333333 !important;",
		"	    }",
		"	    .result-count > .number[data-v-41e71722], .result-count {",
		"	        color: #eeeeee !important;",
		"	    }",
		"	    .ace-clouds {",
		...
		"	        color: white !important;",
		"	    }",
		"	    .inner-card[data-v-62e64f9a], .inner-card[data-v-78fafe5c], .inner-card[data-v-4b8033a4] {",
		"	        background-color: #222222 !important;",
